...
public final class ex5_005fjsp_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                // keyup: 키에서 손을 땠을때 발생하는 이벤트\n");
      out.write("                $('#name').keyup(function(){\n");
      out.write("                    // aJax를 사용하여 비동기식으로 서버의 데이터조회\n");
      out.write("                   \n");
      out.write("                    $.ajax({\n");
      out.write("                       url: \"ex5_postData.jsp\",\n");
      out.write("                       data: {'mid':$(this).val()},\n");
      out.write("                       // 전달받은 값을 callback하여 div에 실시간 출력\n");
